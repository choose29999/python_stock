...
print 'init_TWT38U: start  date %d/%02d/%02d'%(lastest_day.year-1911,lastest_day.month,lastest_day.day)
print 'init_TWT38U: finish date %d/%02d/%02d'%(today.year-1911,today.month,today.day)
log('init_TWT38U: start  date %d/%02d/%02d'%(lastest_day.year-1911,lastest_day.month,lastest_day.day))
