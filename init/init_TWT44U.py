...
drop_table_cmd = 'DROP TABLE TWT44U'	
...
twt44u_buy_quality INT NOT NULL,\
twt44u_sell_quality INT NOT NULL,\
twt44u_total_quality INT NOT NULL,\
twt44u_total_money INT DEFAULT 0,\
PRIMARY KEY (idx))'
